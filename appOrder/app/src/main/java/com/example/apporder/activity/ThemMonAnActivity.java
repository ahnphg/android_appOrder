    ...
    private void saveFood() {
        ...
        uploadImageToImgur(base64Image, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(ThemMonAnActivity.this, "Lỗi khi upload ảnh lên Imgur: " + e.getMessage(), Toast.LENGTH_LONG).show());
            }
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        firestoreHelper.addFood(food,
                                ...
                                error -> runOnUiThread(() -> Toast.makeText(ThemMonAnActivity.this, "Lỗi khi lưu vào Firestore: " + error, Toast.LENGTH_LONG).show()));
                    } catch (Exception e) {
                        runOnUiThread(() -> Toast.makeText(ThemMonAnActivity.this, "Lỗi khi phân tích phản hồi từ Imgur: " + e.getMessage(), Toast.LENGTH_LONG).show());
                    }
                } else {
                    runOnUiThread(() -> Toast.makeText(ThemMonAnActivity.this, "Lỗi khi upload ảnh lên Imgur: " + response.message(), Toast.LENGTH_LONG).show());
                }
            }
        });
    }
